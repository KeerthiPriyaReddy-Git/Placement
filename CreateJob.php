...
<table align="center" border="1" width="65%" height="60%">
	...
	<th colspan="2"  > <input type = "submit" name = "submit" value="Save Job" style="font-size:16px;font-weight:bold; padding:5px;" >	</th>
</table> 
